...
MobileVLA-R1 在三类环境和两种指令难度下都高于 GPT-4o 和 NaVILA。相比简单指令，更值得注意的是 Complex setting：Workspace、Corridor 和 Outdoor 的成功率分别达到 0.91、0.86 和 0.96，说明前面通过 CoT 和 GRPO 学到的长程推理与动作对齐能力能够迁移到论文设置下的真实机器人环境。
